C
C *** LAST REVISED ON 22-JUN-1990 09:09:38.83
C *** SOURCE FILE: [DL.GRAPHICS.LONGLIB77]EXAMP3D.FOR
C
       PROGRAM EXAMP3D
C       
...
C
       CALL NUM3D(0.,0.5,0.,0.,30.,90.,.2,3.14159,0.0)
       CALL NUM3D(0.5,0.,0.5,40.,0.,0.,.2,3.14159,0.0)
       CALL NUM3D(0.5,0.5,0.5,40.,40.,40.,.2,3.14159,0.0)
C
