	PROGRAM PRNTRX
C *** LAST REVISED ON 22-JUN-1990 09:19:05.78
C *** SOURCE FILE: [DL.GRAPHICS.LONGLIB77]PRNTRX.FOR
C
...
C		1. USES IBCLR AND IBSET TO SET BITS IN A WORD.
C		2. THE COMMON BLOCK INITIALIZATIONS FOR RASTMAP
C		   MIGHT NEED CHANGING ON MACHINES WITH DIFFERENT WORD
C		   LENGTHS.
C		3. CONVERSIONS BETWEEN INTEGERS AND HOLLORITH CONSTANTS
C		   USED IN RSCOUT.
C		4. USES IAND AND IOR FOR BIT-WISE AND/OR FUNCTIONS.
C
	CHARACTER*80 NAME
C
