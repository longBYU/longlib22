...
cc601			FORMAT(1X,I<KX>,1X,I<KY>,' s')
601			FORMAT(1X,I6,1X,I6,' s')
		ENDIF
		PENUP=3
		JPCNT=0
	ELSE
...
cc600			FORMAT(1X,'n ',I<KX>,1X,I<KY>,' m')
600			FORMAT(1X,'n ',I6,1X,I6,' m')
			JPCNT=0
		ENDIF
		PENUP=2
		KX=IDIGITS(IX)
...
cc603				FORMAT(1X,I<KX>,1X,I<KY>,1X,'l')
603				FORMAT(1X,I6,1X,I6,1X,'l')
				JPCNT=JPCNT+1
			ENDIF
		ENDIF
	ENDIF
