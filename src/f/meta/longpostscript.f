	PROGRAM POSTSCRIPT
C *** LAST REVISED ON 11-MAR-1993 09:00:17.72
...
601			FORMAT(X,I<KX>,X,I<KY>,' moveto closepath stroke')
		ENDIF
		PENUP=3
		JPCNT=0
	ELSE
...
600			FORMAT(X,'newpath ',I<KX>,X,I<KY>,' moveto')
			JPCNT=0
		ENDIF
		PENUP=2
		KX=IDIGITS(IX)
...
C
		...
		ELSE
			IF (JPCNT.EQ.0.OR.(IX.NE.IXOLD.OR.IY.NE.IYOLD)) THEN
				WRITE (1,603) IX,IY
603				FORMAT(X,I<KX>,X,I<KY>,X,'lineto')
				JPCNT=JPCNT+1
			ENDIF
		ENDIF
	ENDIF
